...
public:
    ...
    bool DescriptorOnCustomPoints(const cv::Mat &img, const Eigen::Matrix2Xf &points_pos, const Eigen::VectorXf &scales, Eigen::VectorXf &descriptors,const Eigen::VectorXf &oritations=Eigen::VectorXf(), bool compute_ori=true);
private:
